...
public class CharacterController : MonoBehaviour, ICharacterController
{
    ...
    public float RightAxisSharpness = 10;
    ...
    private void Update()
    {
        ...
        _rightAxis = Mathf.Lerp(_rightAxis, _targetRightAxis, 1f - Mathf.Exp(-RightAxisSharpness * Time.deltaTime));
        CharacterAnimator.SetFloat("X_Velocity", _rightAxis);
        CharacterAnimator.SetFloat("Y_Velocity", _forwardAxis);
    }
    /// <summary>
            ...
            case CharacterState.Default:
                {
                    ...
                    if (inputs.OnCrouch)
                    {
                        ...
                        if (!_isCrouching)
                        {
                            ...
                            Motor.SetCapsuleDimensions(0.28f, 1f, 0.495f);
                        }
                    }
                    else if (!inputs.OnCrouch)
                    {
            ...
            case CharacterState.Default:
                {
                    ...
                    if (_isCrouching && !_shouldBeCrouching)
                    {
                        ...
                        Motor.SetCapsuleDimensions(0.28f, 1.79f, 0.89f);
